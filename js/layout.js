var l10n = {
    ...
    "l10n_eo": [
      ...
      {"class": "l-er-api-m", "val": "La servilo SASA de kiu ni ricevas datenojn pri la interligoj ne estis atingita. Bonvolu reprovi."},
      {"class": "l-er-net-t", "val": "Neniu retkonekto"},
      {"class": "l-er-net-m", "val": "La retkonekto ne funkcias. Bonvolu funkciigi ĝin kaj reprovu denove."},
      {"class": "l-er-unk-t", "val": "Nekonata eraro"},
      {"class": "l-er-unk-m", "val": "Okazis nekonata eraro."},
      {"class": "lp-from", "val": "Ekveturo de..."},
      {"class": "lp-to", "val": "Alveno al..."},
      {"class": "la-menu", "val": "menuo"},
      {"class": "la-cancel", "val": "nuligi demandon"},
      {"class": "la-hide-input", "val": "enigkampon montri/caŝi"},
      {"class": "la-back", "val": "reen"},
      {"class": "lj-changeSingle", "val": "ŝanĝoj"},
      {"class": "lj-changeMultiple", "val": "ŝanĝoj"},
      {"class": "lj-line", "val": "Linio"},
      {"class": "lj-wait", "val": "atendi"},
      {"class": "lj-walk", "val": "piediri"},
    ]
};
